...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    subtitle: '画船听雨眠',
    // site description
    description: '一写代码的，没什么好关注的',    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: true, // true, false
    // author name
    author: 'karlyn',
    // site url
    url: 'https://karlyn.icu',
    // favicon url
    // recommended formats: svg, png or ico
    favicon: '/icons/icon.svg', // or https://example.com/favicon.svg
  },
  ...
  global: {
    ...
    moreLocales: ['ja','en', 'es', 'ru', 'zh-tw'], // ['de', 'en', 'es', 'fr', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh', 'zh-tw']
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'QQ',
        url: 'https://res.abeim.cn/api/qq/?qq=508586997',
      },
      {
        name: 'Email',
        url: 'btjz_zm@163.com',
